...
<c:forEach items="${cartItemList}" var="cartItem">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="/${cartItem.imageB }"/></a>
		</td>
		<td align="left">
			<a href="<c:url value='/jsps/book/desc.jsp'/>"><span>${cartItem.bname}</span></a>
		</td>
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="吉林省 长春市 高新技术开发区 吉林大学前卫南区前进大街2699号 南苑一公寓360 林书行"/>
		</td>
	</tr>
	<tr>
